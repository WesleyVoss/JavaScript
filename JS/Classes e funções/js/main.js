...
let meuCarro1 = new Carro('Palio', 2014);
let meuCarro2 = new Carro('Saveiro', 2000);

//Imprimindo objetos à classe
...
//Instantiante object
const pessoa1 = new ClassePessoa('Jhon', 'Doe', '1980-04-03');
...
const pessoa3 = new PessoaFunc('Jhon', 'Doe', '1980-04-03');
